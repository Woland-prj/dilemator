...
type NodeNavigationProps = { parentId: UUIDTypes };

export const NodeNavigation = ({ parentId }: NodeNavigationProps) => {
  const isRoot = parentId === NIL_UUID;
  return (
    <button
      class={`btn btn-outline btn-dash h-auto px-1 ${
        isRoot ? "btn-disabled" : ""
      }`}
    >
