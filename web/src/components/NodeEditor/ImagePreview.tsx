...
export const ImagePreview = ({ imageFile }: ImagePreviewProps) => {
  const imagePreview = signal<string | null>(null);
  ...
  return (
    <div class="flex items-center justify-center bg-base-300 border-neutral rounded-box w-full h-full border border-dashed p-4">
      {imagePreview.value ? (
        <img
